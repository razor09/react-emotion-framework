...
import { MaybeUndefined } from '../src/libs/utils/typings'
import { WebpackArgs } from './typings'

export const host = 'localhost'
export const port = 4200
export const fallback = `http://${host}:${port}?`
export const origin = ''
...
export const getProxy = (args: WebpackArgs): MaybeUndefined<ProxyConfigArray> => {
